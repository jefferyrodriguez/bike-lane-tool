...
try:
    ...
    newBL = arcpy.GetParameterAsText(1)
    oldBL = arcpy.GetParameterAsText(2)
    currentBL = arcpy.GetParameterAsText(3)
    ...
    arcpy.AddMessage("Bike Lane Merge has been completed")
    arcpy.AddMessage(arcpy.GetMessages())

except:
       # Report and print any error messages generated
       arcpy.AddError("Could not complete the project tool")
       arcpy.AddMessage(arcpy.GetMessages())
